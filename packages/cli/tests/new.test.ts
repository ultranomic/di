...
import { createProject, type ProjectTemplate } from '../src/commands/new.js'
...
describe('createProject', () => {
  ...
  it('should create src/index.ts with correct imports', async () => {
    ...
    expect(content).toContain("@voxeljs/core")
    expect(content).toContain("@voxeljs/express")
