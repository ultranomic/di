...
import type { Deps, InferDeps } from '../../src/types/deps.js'
  ...
  describe('Deps', () => {
    it('should infer deps from class with static inject', () => {
      ...
      class MyService {
        ...
        constructor(
          private deps: InferDeps<typeof MyService.inject, TestRegistry>,
        ) {}
      }
    ...
    it('should work with mixed token types', () => {
      ...
      class MixedService {
        ...
        constructor(
          private deps: InferDeps<typeof MixedService.inject, TestRegistry>,
        ) {}
      }
    ...
    it('should work with symbol tokens', () => {
      ...
      class SymbolService {
        ...
        constructor(
          private deps: InferDeps<typeof SymbolService.inject, TestRegistry>,
        ) {}
      }
