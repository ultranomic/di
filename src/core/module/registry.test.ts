...
describe('ModuleRegistry', () => {
  ...
  describe('Module Encapsulation', () => {
    ...
    it('should deny access to non-exported tokens', async () => {
      ...
      class UserService {
        static readonly inject: DepsTokens<typeof this> = [InternalLogger];
    ...
    it('should deny access to tokens from unimported modules', async () => {
      ...
      class UserService {
        static readonly inject: DepsTokens<typeof this> = [SecretService];
    ...
    it('should include directly imported module exports in accessible tokens list', async () => {
      ...
      class UserService {
        static readonly inject: DepsTokens<typeof this> = [Logger, SecretService];
