...
describe('Circular Dependencies', () => {
  ...
  describe('dependency chains', () => {
    it('should resolve chain A -> B -> C correctly', () => {
      ...
      class ServiceB {
        static readonly inject: DepsTokens<typeof this> = [ServiceC];
    ...
    it('should resolve multiple dependencies from same service', () => {
      ...
      class Server {
        static readonly inject: DepsTokens<typeof this> = [Config, Logger];
        constructor(
  ...
  describe('deep dependency trees', () => {
    it('should resolve deeply nested dependencies', () => {
      ...
      class B {
        static readonly inject: DepsTokens<typeof this> = [A];
      ...
      class C {
        static readonly inject: DepsTokens<typeof this> = [B];
      ...
      class D {
        static readonly inject: DepsTokens<typeof this> = [C];
    ...
    it('should handle diamond dependency pattern', () => {
      ...
      class Left {
        static readonly inject: DepsTokens<typeof this> = [Shared];
      ...
      class Top {
        static readonly inject: DepsTokens<typeof this> = [Left, Right];
        constructor(
          private left: Left,
          private right: Right,
        ) {}
