...
describe('Container - validateScopes', () => {
  ...
  it('should pass validation when singleton depends on singleton', () => {
    ...
    class Service {
      static readonly inject = [Logger] as const satisfies DepsTokens<Service>;
    }
  ...
  it('should throw when singleton depends on scoped', () => {
    ...
    class SingletonService {
      static readonly inject = [ScopedService] as const satisfies DepsTokens<SingletonService>;
    }
